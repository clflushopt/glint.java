...
public class LogicalPlanTest {
    ...
    public void canProperlyFormatLogicalPlans() throws FileNotFoundException {
        ...
        var filter = BooleanExpr.Eq(new ColumnExpr("state"), new LiteralString("CO"));
        var selection = new Selection(scan, filter);
        var plan = new Projection(selection, List.of(new ColumnExpr("id"),
                new ColumnExpr("first_name"), new ColumnExpr("last_name")));
